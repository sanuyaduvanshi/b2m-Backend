...
public record ExpenseListItem(Guid Id, DateTimeOffset Time, string Description, string? CategoryName, string PaymentMode, decimal Amount, decimal AmountIncTax);
