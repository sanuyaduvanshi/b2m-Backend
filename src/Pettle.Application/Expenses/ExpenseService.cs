...
public record ExpenseListItem(Guid Id, DateTimeOffset Time, string Description, string? CategoryName, string PaymentMode, decimal Amount, decimal AmountIncTax, Guid? CategoryId = null, string? Notes = null, string? ReceiptUrl = null, Guid? RelatedPurchaseOrderId = null, string? PoNumber = null);
